...
export default function AgentDailyHub() {
  ...
  if (loading || !user) return <main className="grid min-h-screen place-items-center bg-[#f4efe5] text-sm text-[#776e61]">Preparing your daily workspace…</main>;
