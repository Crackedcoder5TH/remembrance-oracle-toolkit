...
export function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 md:p-6">
      <div className="max-w-2xl mx-auto cathedral-surface p-5 md:p-6 shadow-lg border border-teal-cathedral/20">
        <div className="space-y-4">
          ...
          {/* Details toggle */}
          {showDetails && (
            <div className="space-y-3 border-t border-teal-cathedral/10 pt-3">
              <div className="space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="px-4 py-2 rounded-lg text-xs font-medium bg-teal-cathedral/20 text-teal-cathedral border border-teal-cathedral/30 hover:bg-teal-cathedral/30 transition-all"
            >
              Accept All
            </button>
            <button
              onClick={handleEssentialOnly}
              className="px-4 py-2 rounded-lg text-xs font-medium text-[var(--text-muted)] border border-teal-cathedral/10 hover:border-teal-cathedral/30 transition-all"
            >
              Essential Only
            </button>
            <button
