...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333;">
  <div style="border-bottom: 2px solid #00a8a8; padding-bottom: 16px; margin-bottom: 24px;">
    <h1 style="font-size: 20px; font-weight: 600; color: #00a8a8; margin: 0;">${companyName}</h1>
  </div>
  ...
  <div style="background: #f7fafa; border-left: 3px solid #00a8a8; padding: 16px; margin: 24px 0; border-radius: 4px;">
  ...
  <p style="font-size: 13px; color: #666;">Your reference number: <code>${lead.leadId}</code></p>

  <p style="font-size: 13px; color: #666;">If you did not submit this request, or if you wish to have your data deleted, please reply to this email or visit our website's privacy page.</p>

  <div style="border-top: 1px solid #e0e0e0; margin-top: 32px; padding-top: 16px; font-size: 12px; color: #999;">
    <p>Best regards,<br>The ${companyName} Team</p>
    <p>This email was sent because a form was submitted with this email address at ${companyName}. If you believe this was sent in error, please disregard this message.</p>
  </div>
</body>
</html>`.trim();
