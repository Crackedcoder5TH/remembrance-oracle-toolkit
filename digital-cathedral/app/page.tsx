    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-4 py-12">
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            rows={3}
            className="w-full bg-soft-gray text-[var(--text-primary)] placeholder-[var(--text-muted)] border border-navy-cathedral/10 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-emerald-accent/60 focus:shadow-[0_0_20px_rgba(45,134,89,0.08)] transition-all resize-none"
          />
        </div>
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span className="text-emerald-accent font-mono text-lg font-semibold">
              {rating}
            </span>
          </div>
          <input
        ...
        <button
          ...
          className="w-full py-3 rounded-lg font-medium text-sm transition-all
            ...
            hover:bg-emerald-accent/90 hover:shadow-[0_0_30px_rgba(45,134,89,0.15)]
        ...
        {/* Error Display */}
        {error && (
          <div className="text-calm-error text-sm text-center">
            {error}
          </div>
        )}
      </form>
      ...
      {whisper && (
        <div className="w-full max-w-lg mt-8 cathedral-surface p-6 md:p-8 cathedral-glow">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-navy-cathedral/8">
            <div className="text-xs text-[var(--text-muted)]">
              Coherence Proxy
            </div>
            <div className="flex items-center gap-2">
              <div
                className="h-2 rounded-full bg-gradient-to-r from-sage-cathedral to-emerald-accent"
                style={{ width: `${whisper.coherence * 100}px` }}
              />
              <span className="text-emerald-accent font-mono text-sm">
