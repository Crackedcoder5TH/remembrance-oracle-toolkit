...
function reflect(rootDir, config = {}) {
  ...
  if (opts._preSnapshot && opts._preSnapshot.rootDir && opts._preSnapshot.rootDir !== rootDir) {
    throw new Error(`Pre-snapshot rootDir mismatch: expected ${rootDir}, got ${opts._preSnapshot.rootDir}`);
  }
