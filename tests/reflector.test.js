...
describe('MCP consolidated tools include reflector-related features', () => {
  it('MCP has at least the 13 consolidated baseline tools (reflector is accessed via module directly)', () => {
    const { TOOLS } = require('../src/mcp/server');
    assert.ok(TOOLS.length >= 13, 'MCP should have at least 13 consolidated tools');
